...
class TreeMap {
    ...
    constructor() {
        ...
        // this.vData = d3.stratify()(this.parsedData);
        // this.vLayout = d3.treemap().size([this.vizWidth, this.vizHeight]).paddingOuter(5);
        // this.vRoot = d3.hierarchy(this.vData).sum(function (d) { return d.data.size; });
        // this.vNodes = this.vRoot.descendants();
        // this.vLayout(this.vRoot);
        // this.vSlices = this.group.selectAll('rect').data(this.vNodes).enter().append('rect');
        // this.vSlices.attr('x', function (d) { return d.x0; })
        //     .attr('y', function (d) { return d.y0; })
        //     .attr('width', function (d) { return d.x1 - d.x0; })
        //     .attr('height', function (d) { return d.y1 - d.y0; });


        globalObj.tree_map = Treemap(this.parsedData, {
